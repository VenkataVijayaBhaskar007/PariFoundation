...
<body>
                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo">
                                <a href="index.html">
                                <img src="admin/logo/parilogo.png" alt="logo" width="80px" height="50px">
                                </a>
                            </div>
                        </div>
    ...
    <div class="slider_area">
        <div class="single_slider  d-flex align-items-center  overlay2"style="background-image: url('img/banner/45.jpg');">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="slider_text  ">
                            <span>Donate Today</span>
                            <h3>We Empower Rural <br/>Youth through<br/> Education and Skill Development</h3>
                            <p>Our goal is to enable rural youth to realise their full potential in life by providing them tools and motivation through education and other activities</p>
...
?> 
    ...
    <section class="about-low-area section-padding2 lg:px-20 " style="margin-top: 80px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="about-caption mb-50">
                     ...
                     <p >     Welcome to Pari Foundation, where compassion meets action. Since our inception in 2007, our dedicated team has worked tirelessly to provide vital social services, with a primary focus on offering financial support to students pursuing education. As a registered non-profit since 2012, under the name "Pari Foundation," we've expanded our impact.Our journey began with a commitment to supporting students in need, ensuring they have the resources to continue their education. Thanks to the dedication of our board members and volunteers, we've successfully raised funds to fulfill our mission. The success of our initial projects inspired us to broaden our horizons.</p>     
                          </div>
                            </div>
                        </div>
    ...
    <!-- latest_activites_area_end  -->
        ...
        <!-- who we are_area_start  -->
        <div class="popular_causes_area section_padding px-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section_title text-center mb-5">
                    <h3><span>Recent Activities </span></h3>
                    
                </div>
            </div>
        </div>

        <p class="mb-30">Engrained in our ethos is a steadfast commitment, together with our invaluable partners and sponsors, to catalyze positive change across all echelons of society, laying the groundwork for a more promising tomorrow.</p>

        <div class="row">
            <div class="col-lg-4">
            <div class="single_cause">
                            <div class="thumb">
                                <img src="https://via.placeholder.com/362x215" alt="">
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="single_counter d-flex align-items-center justify-content-center">
                            ...
                            <div class="events">
                                <h3 class="counter">160 </h3>
                                <p>helped in covid19</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
    ...
    <div class="news__area section_padding">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-55">
                        <h3><span>Events & Updates</span></h3>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="news_active owl-carousel">
                        <div class="single__blog d-flex align-items-center">
                            <div class="thum">
                                <img src="https://via.placeholder.com/264x424" alt="">
                            </div>
                            <div class="newsinfo">
                                <span>Dec 18, 2023</span>
                                <a href="single-blog.html">
                                    <h3>Help for a cause</h3>
                                </a>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. A sit atque repellat at officiis amet illum ipsam quod, animi alias reprehenderit cum consectetur, minima aliquam dignissimos voluptas cumque neque?</p>
                        ...
                        <div class="single__blog d-flex align-items-center">
                            ...
                            <div class="newsinfo">
                                ...
                                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Est dolore sed aperiam magni nulla pariatur suscipit veniam reprehenderit asperiores error? Officia animi nihil sit iste dicta temporibus quas illum nisi?</p>
                                <a class="read_more" href="single-blog.html">Read More</a>
                            </div>
                        </div>
                    </div>
