...
<body>
  ...
  <header>
    ...
    <!-- bradcam_area_end  -->
    <section class="about-low-area section-padding2 xl:px-20 " style="margin-top: 80px;">
        <div class="container">
            <div class="row">
                ...
                ?>            
                    ...
                    <button onclick="redirectToAbout()" data-scroll-nav='1' class="boxed-btn4">Know more</button>
                ...
                <div class="col-lg-6 col-md-12">
                    <!-- about-img -->
                    <div class="about-img ">
                    <div class="about-font-img d-none d-lg-block ml-20 ">
                            <img src="https://via.placeholder.com/250x288" alt="">
                        </div>
                        <div class="about-back-img ">
                            <img src="https://via.placeholder.com/354x453" alt="">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- reson_area_start  -->
    <div class="reson_area section_padding px-0  lg:px-20 xl:px-20">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="section_title text-center mb-30">
                    <h3><span>Empowering Change Together</span></h3>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    ...
                    <div class="help_content">
                        <h4>Education Revolution: Transforming Lives Through 200 Schools</h4>
                        <p>In collaboration with generous donors, our organization has a mission to uplift communities by adopting over 200 schools...</p>
                        <a href="educationrevolution.php" class="read_more">Read More</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    ...
                    <div class="help_content hover:bg-emerald-600">
                        <h4>Empowering Women: Rural Training Programs and Beyond</h4>
                        <p>In addition to our focus on education, our organization recognizes the pivotal role of women in community development...</p>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_reson">
                    ...
                    <div class="help_content">
                        <h4>Nurturing Dreams: Supporting Higher Education and Community Contribution</h4>
                        <p>Our commitment to fostering growth doesn't end with school-level initiatives. We extend a helping hand to aspiring...</p>
                        <a href="#" class="read_more">Read More</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-7">
                    <div class="activites_info">
                        ...
                        <a href="#" data-scroll-nav='1' class="boxed-btn4">View more</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="https://via.placeholder.com/294x313" alt="">
                        </div>
...
<!-- component -->
<div class="text-xl font-bold m-5 text-center"> <div class="section_title text-center mb-55">
                        <h3><span>Our Milestones</span></h3>
                    </div> </span></div>
    ...
    <div class="gallery border-2 rounded mx-auto m-5 bg-white" style="width:750px;">
        ...
        <div class="content-area w-full h-96 overflow-hidden">
          <div class="platform shadow-xl h-full flex">
            <!-- frame start -->
            <div class="each-frame border-box flex-none h-full" title="1/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/2.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Education for All</div>
                        <div class="long-text text-lg">Supported 1200 Students
Providing educational opportunities to empower the next generation.</div> 
            ...
            <div class="each-frame border-box flex-none h-full" title="2/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/3.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Building Foundations</div>
                        <div class="long-text text-lg">Supporting 200+ Schools
Investing in the future by nurturing learning environments across communities.</div> 
                    </div>
                </div>
            </div>
            <!-- frame end -->

            <div class="each-frame border-box flex-none h-full" title="3/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/6.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Empowering Dreams</div>
                        <div class="long-text text-lg">87 Graduates Supported
Enabling individuals to achieve their aspirations through education.</div> 
                    </div>
                </div>
            </div>
            <!-- frame end -->
            <div class="each-frame border-box flex-none h-full" title="4/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/5.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Women Empowerment Hub</div>
                        <div class="long-text text-lg">Empowering Women
Fostering gender equality and empowering women to reach their full potential.</div> 
                    </div>
                </div>
            </div>
            <!-- frame end -->
            <div class="each-frame border-box flex-none h-full" title="5/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/4.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Green Initiatives</div>
                        <div class="long-text text-lg">Planted 5000 Trees
Contributing to environmental sustainability through tree plantation initiatives.</div> 
                    </div>
                </div>
            </div>
            <!-- frame end -->

            <div class="each-frame border-box flex-none h-full" title="6/6"> <!-- title shows in top -->
                <!-- this is full editable area -->
                <div class="main flex w-full p-8"> 
                    <div class="sub w-4/6 my-auto">
                        <img class="w-full p-8" src="img/circle/1.png" alt="">
                    </div>
                    <div class="sub w-full my-auto">
                        <div class="head text-3xl font-bold mb-4">Crisis Response: COVID-19 Support</div>
                        <div class="long-text text-lg">Providing Relief During the Pandemic
Extending a helping hand during challenging times to support communities affected by COVID-19.</div> 
...
<footer class="bg-emerald-50 mx-auto">
  <div class="  px-4 pb-4 pt-10  lg:pt-6">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div class="flex justify-center text-teal-600 sm:justify-start">
        <img src="admin/logo/parilogo.png" class="mr-2  h-auto w-14" alt="logo" />
    <h1 class="text-xl font-bold mt-3 text">Pari Foundation</h1>
        </div>
