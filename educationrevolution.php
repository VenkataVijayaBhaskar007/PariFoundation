...
<!-- 
	...
	<section class="pb-10 lg:px-20 mt-6">
		<div class="container box_1170">
			<h3 class="text-heading pt-10">Why Education</h3>
			<p class="sample-text">
...
Women empowerment is a crucial societal imperative that transcends gender considerations, emphasizing the need for equality, justice, and the full realization of human potential. It involves granting women the tools, resources, and opportunities necessary to participate actively in all spheres of life, from education and employment to decision-making processes. By empowering women, we contribute to the overall progress and development of communities and nations. The promotion of gender equality fosters diversity and enriches perspectives, driving innovation and sustainable growth. Beyond the moral imperative, studies consistently show that societies benefiting from women's empowerment experience improved economic performance, enhanced social cohesion, and increased resilience. Therefore, supporting and championing women empowerment is not only a matter of ethical responsibility but also a strategic investment in building a more equitable, prosperous, and harmonious world.
	...
	<section class=" lg:px-20 ">
		<div class="container box_1170">
			<h3 class="text-heading">What we do in development of education</h3>
			<p class="sample-text">
    ...
    <div class="max-w-screen-xl mx-auto px-4 text-gray-600 gap-x-12 items-start justify-between lg:flex md:px-8">
        <div class="sm:hidden lg:block lg:max-w-xl mt-2">
            <img src="https://via.placeholder.com/870x570" class="rounded-lg" alt="" />
        </div>
        <div class="mt-6 gap-12 sm:mt-0 md:flex lg:block">
            <div class="max-w-2xl">
            <span class="block  text-lg  font-semibold text-green-600 my-2">
              LOrem Ipsum
               </span>
            ...
            <div class="flex-none mt-6 md:mt-0 lg:mt-6">
                <ul class="inline-grid gap-y-8 gap-x-14 grid-cols-2">
                    <li class="">
                        <h4 class="text-4xl text-indigo-600 font-semibold">1200+</h4>
                        <p class="mt-3 font-medium">Schools</p>
                    </li>
                    <li class="">
                        <h4 class="text-4xl text-indigo-600 font-semibold">200</h4>
                        <p class="mt-3 font-medium">Students</p>
                    </li>
                    <li class="">
                        <h4 class="text-4xl text-indigo-600 font-semibold">87</h4>
                        <p class="mt-3 font-medium">Graduates supported</p>
                    </li>
                    <li class="">
                        <h4 class="text-4xl text-indigo-600 font-semibold">110k+</h4>
                        <p class="mt-3 font-medium">Donations</p>
                    </li>
                </ul>
            </div>
        </div>
